<?php
/**
 * cw2019 functions and definitions
 *
...
if ( ! function_exists( 'cw_setup' ) ) :
	...
	function cw_setup() {
		 ...
		 * If you're building a theme based on cw2019, use a find and replace
...
function cw_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'cw' ),
...
function cw_scripts() {
	...
	wp_enqueue_script( 'cw-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( 'cw-ui', get_template_directory_uri() . '/js/cw-ui.js', array('jquery'), '20151215', true);
